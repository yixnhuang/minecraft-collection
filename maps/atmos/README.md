...
**Atmos** is a Minecraft map designed around **roguelike-style action and progression**, drawing inspiration from fast-paced titles like *Hades* and *Ultrakill*. Built entirely using vanilla Minecraft mechanics and resource packs, this map transforms the game into a dynamic adventure with intense combat, character progression, and randomized elements.
