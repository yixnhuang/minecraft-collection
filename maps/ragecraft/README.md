...
**Ragecraft** is a CTM (Complete the Monument) adventure map focused on high-intensity combat and intricate dungeon design. Players progress by conquering hostile regions, overcoming dense enemy encounters, and collecting monument objectives required to complete the map.
